...
**复利（Compound Interest，CI）** 是一款个人使用的游戏化 AI 学习日程 Android 应用，为横屏平板设计（未适配手机）。它把学习任务、确定性排程、专注计时、CI 币经济和数据复盘放进同一个**本地优先**的工作流：今天投入的每一分钟专注，都会立刻变成看得见的币、经验和头衔，再反哺明天的计划。
